!function () {
    "ace" in window || (window.ace = {}), ace.config = {
        ...
        saveState: function (a, b, c, d) {
            ...
            var b = b || "class", e = a.getAttribute("id"), f = ace.data.get("state", "id-" + e) || {};
            if ("string" == typeof f)try {
                f = JSON.parse(f)
            } catch (g) {
                f = {}
            }
            var h, i = "undefined" != typeof c, j = !1, k = /class/i, l = /checked|disabled|readonly|value/i;
            ...
            if (!a || "string" == typeof a && !(a = document.getElementById(a)) || !a.hasAttribute("id"))return !1;
            var c = a.getAttribute("id"), d = ace.data.get("state", "id-" + c) || {};
            ...
            var f = function (a, b, c) {
                var d = /class/i, e = /checked|disabled|readonly|value/i;
                if (d.test(b)) {
                    if ("object" == typeof c) {
            ...
            if (void 0 !== b) d.hasOwnProperty(b) && null !== d[b] && f(a, b, d[b]); else for (var g in d)d.hasOwnProperty(g) && null !== d[g] && f(a, g, d[g])
        ...
        var a = function () {
            var a = !1, b = "animation", c = "", d = "Webkit Moz O ms Khtml".split(" "), e = "",
        ...
        (1 == a || a === b || 0 == a) && "localStorage" in window && null !== window.localStorage ? (d = ace.storage, e = 1) : null == d && (2 == a || a === b) && "cookie" in document && null !== document.cookie && (d = ace.cookie, e = 2), this.set = function (a, b, f, g, h, i) {
            if (d)if (f === i) f = b, b = a, null == f ? d.remove(c + b) : 1 == e ? d.set(c + b, f) : 2 == e && d.set(c + b, f, ace.config.cookie_expiry, g || ace.config.cookie_path); else if (1 == e) null == f ? d.remove(c + a + "_" + b) : (h && "object" == typeof f && (f = JSON.stringify(f)), d.set(c + a + "_" + b, f)); else if (2 == e) {
                var j = d.get(c + a), k = j ? JSON.parse(j) : {};
                if (null == f) {
